											...
											<?php $No=1; 
												...
												<tr>
													...
													<div id="edit_data_Modal<?php echo $catatan->id_catatan; ?>" class="modal fade">
														...
														<form class="form-horizontal" method="post" action="<?php echo base_url() . 'C_pembukuan/update_catatanUser/' . $catatan->id_catatan; ?>"  enctype="multipart/form-data">
															<input type="hidden" name="id_user" class="form-control" value="<?php echo $catatan->id_user; ?>">
																<h6>Uraian</h6>
													...
													<div class="modal-dialog">
														...
														<div class="modal-body">
														<form class="form-horizontal" method="post" action="<?=base_url()?>C_pembukuan/hapus_catatanUser/<?=$catatan->id_catatan?>">
								...
								<div class="card">
									...
									<div class="table-responsive">
										<table class="table table-hover">
											...
											<?php foreach ($join2 as $data) : ?>
												<?php $masa_tanam =  $data->komoditas . " - " . $data->masa . " bulan"?>
													<p><a class="btn btn-primary" href="<?=base_url()?>C_pembukuan/detail_catatanMasaTanamUser/<?=$data->id_user?>/<?=$data->id_tanam?>">
														Lihat Laporan 
													</a><class="card-category"> <?php echo $data->id_tanam; ?> : <span><?php echo $masa_tanam; ?></span>
													</p>
											<?php endforeach; ?>
									</div>
								</div>
...
<div id="add_data_Modal" class="modal fade">
 <div class="modal-dialog">
  <div class="modal-content">
   ...
   <div class="modal-body">
   <form action="<?=base_url()?>C_pembukuan/tambah_masaTanamUser" method="post" enctype="multipart/form-data">
   <input type="hidden" name="id_user" class="form-control" value="<?php echo $detail->id_user; ?>">
     <h6>Komoditas</h6>
...
<div id="add_data_Modal2" class="modal fade">
 <div class="modal-dialog">
  <div class="modal-content">
   ...
   <div class="modal-body">
   <form action="<?=base_url()?>C_pembukuan/tambah_catatanUser" method="post" enctype="multipart/form-data">
   <input type="hidden" name="id_user" class="form-control" value="<?php echo $detail->id_user; ?>">   
   <h6>Masa Tanam</h6>
